    ...
    <ScrollView>
      <View style={{ flexDirection: 'row', paddingHorizontal: 10, }}>
        ...
        <View style={{ flex: 5, paddingLeft: 8 }}>
          ...
          <View style={styles.delLoc}>
            <TouchableOpacity style={{ backgroundColor: '#6193e5', borderRadius: 50, paddingVertical: 7, paddingHorizontal: 20, marginRight: 10 }}>
              <Text style={{ fontSize: 12.5, fontFamily: 'Poppins-Regular', color: '#fff', }}>Move To Prepared</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
...
export default UnderPreparation;
