    ...
    <ScrollView>
      <View style={{ flexDirection: 'row', paddingHorizontal: 10, }}>
        ...
        <View style={{ flex: 5, paddingLeft: 8 }}>
          ...
          <View style={styles.delLoc}>
            <TouchableOpacity style={{ backgroundColor: '#e86d90', borderRadius: 50, paddingVertical: 7, paddingHorizontal: 20, marginRight: 10 }}>
              <Text style={{ fontSize: 12.5, fontFamily: 'Poppins-Regular', color: '#fff', }}>Move to Delivery</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
