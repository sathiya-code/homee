export const PrimaryGreen = '#09B44D';

export const SecondaryGreen = '#D1F0DD';

export const HomeBgColor = '#f4fbf8';

export const AppBackground = '#D1F0DD';

export const TextColor1 = '#1F2220';

export const TextColor2 = '#969696';
